    ...
    public static class CLCalc
    {
        ...
        public static class Program
        {
            ...
            public class MemoryObject : IDisposable
            {
                ...
                public virtual void SetAsArgument(int ArgIndex, ComputeKernel Kernel)
                {
            ...
            public class Value<T> : MemoryObject where T:struct
            {
                ...
                {
                    Kernel.SetValueArgument(ArgIndex, value);
                }
            }
            ...
            public class Variable : MemoryObject
            {
                ...
                static public CLCalc.Program.Variable Create<T>(ComputeBuffer<T> buffer) where T : struct
                {
                    return new CLCalc.Program.Variable(buffer, (int)buffer.Size, (int)buffer.Count);
                }
