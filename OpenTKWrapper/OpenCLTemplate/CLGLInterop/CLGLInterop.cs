...
namespace OpenTKWrapper.CLGLInterop
{

    /// <summary>OpenGL render control</summary>
    public class GLAdvancedRender
    {
        ...
        public delegate void DoAdvancedDraw();
        public delegate bool OnKeyPressed(KeyEventArgs e);
        public delegate bool OnMouseDown(MouseEventArgs e);
        public delegate bool OnMouseUp(MouseEventArgs e);
        ...
        DoAdvancedDraw drawHandle = null;
        OnKeyPressed keyPressedHandle = null;
        OnMouseDown mouseDownHandle = null;
        OnMouseUp mouseUpHandle = null;
        OnMouseMove mouseMoveHandle = null;
        public void SetAdvancedDrawMethod(DoAdvancedDraw draw)
        {
            this.drawHandle = draw;

        }
        public void SetMouseDownMethod(OnMouseDown method)
        {
            this.mouseDownHandle = method;
        }
        public void SetMouseUpMethod(OnMouseUp method)
        {
            this.mouseUpHandle = method;
        }
        public void SetMouseMoveMethod(OnMouseMove method)
        {
            this.mouseMoveHandle = method;
        }
        public void SetKeyPressedMethod(OnKeyPressed keypress)
        {
            this.keyPressedHandle = keypress;
        }
        public OpenTK.Matrix4 modelView = OpenTK.Matrix4.Identity;
        ...
        /// <param name="DeviceNumber">Index of device to use from ComputePlatform.Platforms[0].Devices. Use -1 for default</param>
        public GLAdvancedRender(System.Windows.Forms.Form ParentForm, bool CreateCLGLCtx, int DeviceNumber)
        {
        ...
        protected void InitGL(bool CreateCLGLCtx, int deviceNumber,int platformNumber,ComputeDeviceTypes deviceType)
        {
            ...
            float[] position = { 0.0f, -40.0f, 1000.0f, 1.0f };
        ...
        private void sOGL_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (MouseMode == MouseMoveMode.TranslateModel || MouseMode == MouseMoveMode.RotateModel)
            {
                ...
                else if (e.Button == MouseButtons.Middle)
                {
                    if (clickMiddle)
                    {
                        this.center -= this.zFar * 0.001 * ((e.X - lastX) * this.esq - this.up * (e.Y - lastY));
                        this.eye -= this.zFar * 0.001 * ((e.X - lastX) * this.esq - this.up * (e.Y - lastY));
        ...
        {
            if (keyPressedHandle != null)
            {
                if (keyPressedHandle.Invoke(e)) return;
            }
        ...
        public Vector eye = new Vector(0, 0, 215);
        public Vector trans = new Vector(0, 0, 0);
        /// <summary>Front vector</summary>
        public Vector front = new Vector(0, 0, 1);
        /// <summary>Up vector</summary>
        public Vector up = new Vector(0, 1, 0);
        /// <summary>Left vector</summary>
        public Vector esq = new Vector(1, 0, 0);
        /// <summary>Camera eye distance.</summary>
        public double distEye = 215;
...
";
        ...
        private void Draw()
        {
            ...
            else
            {
                ...
                GL.LoadIdentity();
                OpenTK.Matrix4d m1 = OpenTK.Matrix4d.CreatePerspectiveFieldOfView(Math.PI * 0.25f,
                    (double)GLCtrl.Width / (double)GLCtrl.Height, (double)Math.Max(zNear,1), (double)zFar);
                GL.LoadMatrix(ref m1);
        ...
        private void DoDraw()
        {
            ...
            if (drawHandle != null)
            {
                ...
                GL.Translate(trans.x / (double)GLCtrl.Width, -trans.y / (double)GLCtrl.Height, 0);
                OpenTK.Matrix4d m1 = OpenTK.Matrix4d.CreatePerspectiveFieldOfView(Math.PI * 0.25f,
                    4 / 3.0f, 200, 3000);
...
";
    ...
    public class GLFont
    {
        ...
        public GLAdvancedRender.GLVBOModel[] GLchars;
        ...
        public GLFont(Font f, float GLNormalizationScale)
        {
            ...
            OpenTKWrapper.Isosurface.MarchingCubes mc = new OpenTKWrapper.Isosurface.MarchingCubes(bmpVals);
            ...
            GLchars = new GLAdvancedRender.GLVBOModel[256];
            ...
            for (int i = 0; i < 256; i++)
            {
                ...
                if (intensitiesAdded)
                {
                    ...
                    GLchars[i] = new GLAdvancedRender.GLVBOModel(BeginMode.Triangles);
        ...
        public GLFont(string filename)
        {
            ...
            for (int indChar = 0; indChar <= nChars; indChar++)
            {
                ...
                if (nVert > 0)
                {
                    ...
                    //Creates the model
                    GLchars[indChar] = new GLAdvancedRender.GLVBOModel(BeginMode.Triangles);
        ...
        public List<GLAdvancedRender.GLVBOModel> Draw3DString(string s, GLAdvancedRender target)
        {
            List<GLAdvancedRender.GLVBOModel> GLstr = new List<GLAdvancedRender.GLVBOModel>();
            ...
            for (int i = 0; i < sb.Length; i++)
            {
                ...
                {
                    GLAdvancedRender.GLVBOModel m = new GLAdvancedRender.GLVBOModel(GLchars[sb[i]]);
        ...
        /// <param name="s">String to write</param>
        public List<GLAdvancedRender.GLVBOModel> Draw3DString(string s)
        {
